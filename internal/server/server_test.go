...
import (
	...
	api "github.com/hexnaught/proglog/api/v1"
	"github.com/hexnaught/proglog/internal/auth"
	"github.com/hexnaught/proglog/internal/config"
	"github.com/hexnaught/proglog/internal/log"
...
func setupTests(t *testing.T, fn func(*Config)) (rootClient, nobodyClient api.LogClient, cfg *Config, teardown func()) {
	t.Helper()
